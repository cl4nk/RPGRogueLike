...
namespace UI
{
    public class UIGame : MonoBehaviour
    {
        ...
        public Compass.Compass Compass { get; private set; }
        ...
        private void Awake()
        {
            ...
            Compass = transform.Find("Compass").GetComponent<Compass.Compass>();
        ...
        {
            transform.Find("AlterationPanel/" + labelName).GetComponent<PotionSprite>()
                .UpdateNumberPotion(nbAlteration);
        }
