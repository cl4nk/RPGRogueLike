...
public class SpellsLauncher : MonoBehaviour
{
    ...
    {
        Character charac = FindObjectOfType<Character>();
    ...
    private void ApplyBonus(Character c, BonusSpell.BONUS_TYPE bonusType, int bonusValue)
    {
        switch (bonusType)
        {
    ...
    private void RemoveBonus(Character c, BonusSpell.BONUS_TYPE bonusType, int bonusValue)
    {
        switch (bonusType)
        {
            case BonusSpell.BONUS_TYPE.Health:
    ...
    private IEnumerator TemporaryBonusEffect(Character c, BonusSpell spell)
    {
